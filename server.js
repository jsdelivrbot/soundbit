...
app.get('/searchInfo', function (req, res) {
  /*var searchAuth = new XMLHttpRequest();



  searchAuth.open("GET", "https://accounts.spotify.com/authorize?client_id=62de9dc50722467795cfd0d4056e42aa&response_type=code&redirect_uri=http://localhost:3000/callback");
  searchAuth.send();*/
  var keyword = req.query.keyword;
  console.log(keyword);
/*
